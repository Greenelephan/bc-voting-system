...
class PublicElectionHomeTablet extends StatefulWidget {
  const PublicElectionHomeTablet({super.key});

  @override
  _PublicElectionHomeTabletState createState() => _PublicElectionHomeTabletState();
}

class _PublicElectionHomeTabletState extends State<PublicElectionHomeTablet> {
