...
class PublicElectionHomeMobile extends StatefulWidget {
  const PublicElectionHomeMobile({super.key});

  @override
  _PublicElectionHomeMobileState createState() => _PublicElectionHomeMobileState();
}

class _PublicElectionHomeMobileState extends State<PublicElectionHomeMobile> {
