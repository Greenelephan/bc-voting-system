...
class SecondElection extends StatefulWidget {
  final String votingId;

  const SecondElection({required this.votingId});

  @override
  _SecondElectionState createState() => _SecondElectionState();
}

class _SecondElectionState extends State<SecondElection> {
  ...
  void _storeVote(int candidateId, String candidateName) async {
    await secureStorage.write(key: 'selectedVote2', value: candidateId.toString());
    await secureStorage.write(key: 'selectedVote2Name', value: candidateName);
  }
